...
<div>
<h3 class="float-md-center mb-0 text-black">Registro</h3>
<div class="container align-center p-5">
    ...
    <form class="form" action="{{route('validar-registro')}}" method="POST">
        <h5>Registro</h5>
        @csrf
        <div class="my-5 mx-5">
        ...
        <div>
            <p class="text-secondary">tienes ya una cuenta? <a class="text-primary" href="{{route('login')}}">Logeate</a></p>
        </div>
    </form>
</div>
